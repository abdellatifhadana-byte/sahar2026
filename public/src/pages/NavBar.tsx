    ...
    <>
      ...
      <header className="topnav topnav-desktop" style={{ zIndex:100 }}>
        ...
        <div className="nav-logo" style={{ position:'relative', zIndex:1, flexShrink:0 }}>
          <div style={{ width:34,height:34,borderRadius:9,overflow:'hidden',background:'#07080D',border:'1px solid rgba(255,255,255,.1)',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0,boxShadow:'0 2px 10px rgba(255,77,26,.25)' }}>
      ...
      <header className="topnav topnav-mobile">
        ...
        <div className="nav-logo" style={{ position:'relative',zIndex:1 }}>
          <div style={{ width:30,height:30,borderRadius:8,overflow:'hidden',background:'#07080D',border:'1px solid rgba(255,255,255,.1)',display:'flex',alignItems:'center',justifyContent:'center' }}>
            <img src="/sahar-logo-text.png" alt="S" style={{ width:'100%',height:'100%',objectFit:'contain' }}
              onError={e => { (e.currentTarget as HTMLImageElement).style.display='none'; (e.currentTarget.parentElement as HTMLElement).innerHTML='<span style="font-size:13px;font-weight:900;color:#FF4D1A">S</span>'; }}
            />
          </div>
          ...
          <div className="sidebar-panel" onClick={e => e.stopPropagation()}>
            <div style={{ padding:'16px 16px 12px',borderBottom:'1px solid var(--border)',display:'flex',alignItems:'center',justifyContent:'space-between' }}>
              <div className="nav-logo">
                <div style={{ width:28,height:28,borderRadius:7,overflow:'hidden',background:'#07080D',border:'1px solid rgba(255,255,255,.1)',display:'flex',alignItems:'center',justifyContent:'center' }}>
                  <img src="/sahar-logo-text.png" alt="S" style={{ width:'100%',height:'100%',objectFit:'contain' }}
